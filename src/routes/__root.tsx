  ...
  head: () => ({
    meta: [
      ...
      { title: "Extreme Race — Você contra seus próprios limites" },
      {
        name: "description",
        content:
          "5 km. 30 obstáculos. 1 missão. A corrida de obstáculos mais extrema do Brasil. Inscreva-se agora.",
      },
      { property: "og:title", content: "Extreme Race — Você contra seus próprios limites" },
      {
        property: "og:description",
        content:
          "5 km. 30 obstáculos. 1 missão. A corrida de obstáculos mais extrema do Brasil.",
      },
